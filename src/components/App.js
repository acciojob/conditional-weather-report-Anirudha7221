  ...
  return (
    <div>
...

        {
         ...
         temp && temp>20 &&
         ( <div>
           <p> <span style={{color:"red"}}>Temparature: {temp}</span> <span style={{color:"red"}}> Condtions: {weather}</span></p>
...
}
  {
          ...
          (
            ...
            <div>
              ...
              <p> <span style={{color:"blue"}}>Temparature: {temp}</span> <span style={{color:"blue"}}> Condtions: {weather}</span></p>
